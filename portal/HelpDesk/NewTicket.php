...
for ($i = 0; $i < count($result); $i++) {
    ...
    if ($result[$i]['cf_751'] != '') {
        $cf_751 = $result[$i]['cf_751'];
    }
    if ($result[$i]['cf_753'] != '') {
        $cf_753 = $result[$i]['cf_753'];
    }
    if ($result[$i]['cf_755'] != '') {
        $cf_755 = $result[$i]['cf_755'];
    }
...
?>
                            ...
                            <div class="form-group">
                                <label>Requete</label>
                                <<?php echo getComboList('cf_751', $cf_751); ?>
                            </div>

                            <div class="form-group">
                                <label>Sous Categorie</label>
<?php echo getComboList('cf_753', $cf_753); ?>
                            </div>


                            <div class="form-group">
                                <label>Identifiant</label>
<?php echo getComboList('cf_755', $cf_755); ?>
                            </div>
