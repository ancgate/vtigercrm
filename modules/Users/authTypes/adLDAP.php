...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@sogebank.com";
    ...
    * @var string
    */
	protected $baseDn = "DC=SOGEBANK,DC=COM"; 
    ...
    * @var array
    */
    protected $domainControllers = array("sogebank.com");
    ...
    * @var string
    */
	protected $adminUsername ='s12';
    protected $adminPassword = 'Sogebank01';
