...
$AUTHCFG['ad_accountSuffix'] = '@sogebank.com';
$AUTHCFG['ad_basedn']        = 'DC=sogebank,DC=com';
$AUTHCFG['ad_dc']            = array("sogebank.com"); //array of domain controllers
$AUTHCFG['ad_username']      = 'CN=Projet S12,OU=Direction Recherches et Developpement,OU=Informatiques et Technologies,OU=Conseil_D_Administration,DC=sogebank,DC=com'; //optional user/pass for searching
$AUTHCFG['ad_pass']          = 'Sogebank01';
